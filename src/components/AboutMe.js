    ...
    <>
      <Grid className={classes.main} container spacing={3}>
        ...
        <Grid className={classes.secondary} item xs={10} md={5}>
          ...
          <br></br>
          <h2>
            Full-Stack Web Developer with a background in marketing aiming to
            create a more consumer-centric experience on the web. Earned a
            full-stack web development certification through the University of
